# PatchouliButton-Backport
PatchouliButton-Backport is a minecraft mod addon for the mod [Patchouli](https://www.curseforge.com/minecraft/mc-mods/patchouli-fabric) which adds a button to visit all patchouli books. (Fabric 1.18.x)
